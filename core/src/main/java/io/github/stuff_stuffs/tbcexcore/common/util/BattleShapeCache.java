...
public final class BattleShapeCache {
    ...
    public Iterator<BattleParticipantHandle> getParticipants() {
        return Spliterators.iterator(battleState.getSpliteratorParticipants());
    }
    ...
    public boolean rayCast(final Vec3d start, final Vec3d end, final BattleParticipantHandle... exclusions) {
        ...
        final HitResult hitResult = MathUtil.rayCast(start, end, pos -> {
