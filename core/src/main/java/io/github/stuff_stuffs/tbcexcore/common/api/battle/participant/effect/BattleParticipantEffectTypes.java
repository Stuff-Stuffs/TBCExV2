...
public final class BattleParticipantEffectTypes {
    ...
    public static final BattleParticipantEffectType<RacialStatEffect> RACIAL_STAT_BATTLE_PARTICIPANT_EFFECT = new BattleParticipantEffectType<>(new LiteralText("Racial"), RacialStatEffect.CODEC);
    public static final BattleParticipantEffectType<LevelStatEffect> LEVEL_STAT_BATTLE_PARTICIPANT_EFFECT = new BattleParticipantEffectType<>(new LiteralText("Level"), LevelStatEffect.CODEC);
