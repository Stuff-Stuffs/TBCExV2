...
import io.github.stuff_stuffs.tbcexcore.common.impl.battle.participant.effect.LevelStatEffectView;
import io.github.stuff_stuffs.tbcexcore.common.impl.battle.participant.effect.RacialStatEffect;
import io.github.stuff_stuffs.tbcexcore.common.impl.battle.participant.effect.RacialStatEffectView;
...
public final class BattleParticipantEffectTypes {
    ...
    public static final BattleParticipantEffectType<RacialStatEffectView, RacialStatEffect> RACIAL_STAT_BATTLE_PARTICIPANT_EFFECT = new BattleParticipantEffectType<>(new LiteralText("Racial"), RacialStatEffect.CODEC, RacialStatEffect::combine, RacialStatEffect::extract);
    public static final BattleParticipantEffectType<LevelStatEffectView, LevelStatEffect> LEVEL_STAT_BATTLE_PARTICIPANT_EFFECT = new BattleParticipantEffectType<>(new LiteralText("Level"), LevelStatEffect.CODEC, LevelStatEffect::combine, LevelStatEffect::extract);
