...
import io.github.stuff_stuffs.tbcexcore.common.api.battle.event.bounds.BattlePostSetBoundsEvent;
import io.github.stuff_stuffs.tbcexcore.common.api.battle.event.bounds.BattlePreSetBoundsEvent;
...
public final class BattleEvents {
    ...
    public static final EventKey<BattlePreSetBoundsEvent, BattlePreSetBoundsEvent.Mut> BATTLE_PRE_SET_BOUNDS_EVENT = EventKey.get(BattlePreSetBoundsEvent.class, BattlePreSetBoundsEvent.Mut.class);
    public static final EventKey<BattlePostSetBoundsEvent, BattlePostSetBoundsEvent.Mut> BATTLE_POST_SET_BOUNDS_EVENT = EventKey.get(BattlePostSetBoundsEvent.class, BattlePostSetBoundsEvent.Mut.class);
    ...
    public static void init() {
        BattleState.BATTLE_EVENT_INIT.register(initializer -> {
            ...
            initializer.add(BATTLE_PRE_SET_BOUNDS_EVENT, (enter, exit) -> new SimpleEvent<>(BattlePreSetBoundsEvent::convert, BattlePreSetBoundsEvent.invokerFactory(), BattlePreSetBoundsEvent.Mut.class, enter, exit));
            initializer.add(BATTLE_POST_SET_BOUNDS_EVENT, (enter, exit) -> new SimpleEvent<>(BattlePostSetBoundsEvent::convert, BattlePostSetBoundsEvent.invokerFactory(), BattlePostSetBoundsEvent.Mut.class, enter, exit));
        });
    }
