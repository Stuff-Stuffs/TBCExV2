...
public final class GuiRenderLayers extends RenderPhase {
    ...
    public static final DepthTest NO_DEPTH_TEST = RenderPhase.ALWAYS_DEPTH_TEST;
    public static final DepthTest DEPTH_TEST = RenderPhase.LEQUAL_DEPTH_TEST;
    public static final Target MAIN_TARGET = RenderPhase.MAIN_TARGET;
    public static final Target TRANSLUCENT_TARGET = RenderPhase.TRANSLUCENT_TARGET;
    public static final Transparency NO_TRANSPARENCY = RenderPhase.NO_TRANSPARENCY;
    public static final Transparency TRANSLUCENT_TRANSPARENCY = RenderPhase.TRANSLUCENT_TRANSPARENCY;
    public static final WriteMaskState ALL_MASK = RenderPhase.ALL_MASK;
    public static final WriteMaskState COLOR_MASK = RenderPhase.COLOR_MASK;
    private static final WriteMaskState NONE_MASK = new WriteMaskState(false, false);
    ...
    private static final Map<String, Shader> SHADERS_PHASE = new Object2ReferenceOpenHashMap<>();
    private static final Map<Identifier, Texture> TEXTURE_MAP = new Object2ReferenceOpenHashMap<>();
    ...
    private static final Shader POS_COLOUR_SHADER = new Shader(GameRenderer::getPositionColorShader);
    ...
    public static Shader getShader(final String shaderName, final VertexFormat format) {
        return SHADERS_PHASE.computeIfAbsent(shaderName, name -> createShaderPhase(name, format));
    }

    public static Texture getTexture(final Identifier id) {
        return TEXTURE_MAP.computeIfAbsent(id, identifier -> new Texture(identifier, false, false));
    }

    private static Shader createShaderPhase(final String shaderName, final VertexFormat format) {
